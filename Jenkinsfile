            ...
            steps {
                sshagent (credentials: ['ssh-deploy']) {
                    sh '''
                        ...
                        ansible-playbook -i ~/workspace/ansible-project/ansible-test-jenkins/hosts.yml -l deploymentjenkins ~/workspace/ansible-project/ansible-test-jenkins/playbooks/postgres.yml
                        '''
            }
